...
<head>
    ...
    <title>THE SMK- Administration</title>
    <style>
        body {
            margin: 0;
...
<body>
    ...
    <header>
        <div class="tblogo">
            ...
            <div class="ltext"><h1 >The SMK</h1></div>
        </div>
    ...
    <div class="admin-container">
        ...
        <div class="admin-items">
            ...
            <div class="admin-item">
                <img src="P2.jpg" alt="Master Chef">
                <div class="admin-details">
                    <h3>KAMAL</h3>
            ...
            <div class="admin-item">
                <img src="P4.jpg" alt="Assistant Managing Director">
                <div class="admin-details">
                    <h3>BALAJI</h3>
    ...
    <footer>
        <p>Designed by : RIYAZ M(24900356)</p>
    </footer>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>THE SMK- contact us</title>
    <style>
        body {
            margin: 0;
            font-family: 'Arial', sans-serif;
...
<body>
    ...
    <section class="contact-section">
        <div class="contact-details">
            ...
            <p><strong>Phone:</strong> +91 2134567890</p>
...
<body>
    ...
    <div class="banner">
        <div class="banner-content">
            <h1>Welcome to THE SMK HOTEL</h1>
...
<body>
    ...
    <div class="menu-container">
        ...
        <div class="menu-items">
            <div class="menu-item">
                <img src="F1 (1).jpg" alt="Lobster Bisque">
            ...
            <div class="menu-item">
                <img src="F1 (2).jpg" alt="Grilled Octopus">
                <div class="menu-details">
            ...
            <div class="menu-item">
                <img src="F1 (3).jpg" alt="Shrimp Scampi">
                <div class="menu-details">
                    <h3>Shrimp Scampi</h3>
            ...
            <div class="menu-item">
                <img src="F1 (4).jpg" alt="Bouillabaisse">
                <div class="menu-details">
                    <h3>Bouillabaisse</h3>
            ...
            <div class="menu-item">
                <img src="F1 (5).jpg" alt=" Sushi & Sashimi">
                <div class="menu-details">
                    <h3> Sushi & Sashimi</h3>
            ...
            <div class="menu-item">
                <img src="F1 (7).jpg" alt=" Paella de Mariscos">
                <div class="menu-details">
            ...
            <div class="menu-item">
                <img src="F1 (8).jpg" alt="Crab Cakes">
                <div class="menu-details">
                    <h3>Crab Cakes</h3>
            ...
            <div class="menu-item">
                <img src="F1 (9).jpg" alt="Fish Tacos">
                <div class="menu-details">
                    <h3>Fish Tacos</h3>
            ...
            <div class="menu-item">
                <img src="F1 (10).jpg" alt="Salmon Teriyaki">
                <div class="menu-details">
            ...
            <div class="menu-item">
                <img src="F1 (11).jpg" alt="Jambalaya">
                <div class="menu-details">
                    <h3>Jambalaya</h3>
            ...
            <div class="menu-item">
                <img src="F1(12).jpg" alt="Chilli Crab">
                <div class="menu-details">
                    <h3>Chilli Crab</h3>
...
## OUTPUT:
![alt text](<Screenshot 2024-12-23 112622.png>)
![alt text](<Screenshot 2024-12-23 112646.png>)
![alt text](<Screenshot 2024-12-23 112658.png>)
![alt text](<Screenshot 2024-12-23 112708.png>)
![alt text](<Screenshot 2024-12-23 112722.png>)
